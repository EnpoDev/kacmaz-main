...
export default function CompanyDetailPage() {
    ...
    return (
        <div className="font-sans bg-gray-50 min-h-screen">
            ...
            <button
                className="fixed bottom-10 right-10 py-2 px-3 rounded-lg bg-orange-500 text-white shadow-lg transition z-50">
            ...
            <section className="bg-gradient-to-r from-gray-800 to-gray-600 bg-cover bg-no-repeat lg:h-96 h-72 relative">
                ...
                <div
                    className="flex flex-col items-center justify-center gap-4 h-full relative z-50 text-white text-center px-5 lg:px-0"></div>
            </section>
            ...
            <section className="container mx-auto py-12 px-5 lg:px-0">
                <div className="flex flex-col-reverse md:flex-row items-start gap-5">
                    ...
                    <div className="md:w-1/4 md:-mt-80 relative z-50">
                        ...
                        <div className="bg-white rounded-lg border p-3 space-y-5">
                            ...
                            <div className="grid grid-cols-3 gap-2">
                                ...
                                <button className="py-2 px-5 text-white rounded-lg bg-orange-500 text-sm">Paylaş
                                </button>
                                <button className="py-2 px-5 text-white rounded-lg bg-orange-500 text-sm">Takip Et
                                </button>
                            </div>
                            ...
                            <div className="border rounded-lg">
                                {[
                                    ...
                                    <div key={stat.label}
                                         className={`flex items-center justify-between text-sm py-2 px-3 ${index < array.length - 1 ? 'border-b' : ''}`}>
                                        <h5>{stat.label}</h5>
                                ...
                                <div className="mt-3">
                                    <div className="flex items-center gap-2 flex-wrap">
                                        {expertiseAreas.slice(0, expandedItems.expertise ? expertiseAreas.length : 3).map((area, index) => (
                                            <div key={index}
                                                 className="bg-blue-600 rounded-full text-white text-sm py-1 px-2">
                                                {area}
                                            </div>
                                        ))}
                                        <button
                            ...
                            <div className="border p-2 rounded-lg space-y-2">
                                ...
                                <input type="text"
                                       className="border rounded-lg py-1.5 px-3 bg-inherit focus:outline-none w-full"
                                       placeholder="E-Posta"/>
                                <textarea className="border rounded-lg py-1.5 px-3 bg-inherit focus:outline-none w-full"
                                          placeholder="Konu" rows="4"></textarea>
                            ...
                            <div className="border p-2 rounded-lg space-y-3">
                                ...
                                <p>Bu acenteyle iletişime geçebilir ve listelerden doğrudan tur talebinde
                                    bulunabilirsiniz. <a href="#" className="text-orange-500">Daha fazla bilgi
                                        edinin</a></p>
                                <button className="py-1.5 w-full bg-orange-500 rounded-lg text-white text-sm">
                    ...
                    <div className="md:w-3/4 w-full">
                        ...
                        <div className="-mt-28 mb-10 relative z-50 hidden md:flex items-center justify-between">
                            ...
                            <div className="flex items-center flex-wrap gap-2">
                                {Array(2).fill().map((_, i) => (
                                    <div key={i}
                                         className="border border-yellow-500 rounded-lg p-2 text-yellow-500 text-center">
                        ...
                        {/* Tabs */}
                        <div
                            className="border p-2 flex items-center flex-wrap lg:justify-between rounded-lg text-sm gap-1">
                            {tabs.map(tab => (
                                <button
                                    key={tab.id}
                        ...
                        <div className="pt-4">
                            ...
                            {activeTab === 'projeler' && (
                                <div>
                                    ...
                                    <div
                                        className="border p-2 inline-flex flex-wrap items-center gap-2 rounded-lg text-sm">
                                            ...
                                            {projects.map(project => (
                                                <div key={project.id} className="bg-white rounded-lg p-2.5 shadow-lg">
                                                    <div className="relative">
                                                        <img className="rounded-lg w-full md:h-72 h-64 object-cover"
                                                             src={project.image} alt=""/>
                                                        <div
                                                            className="absolute inset-0 h-full flex flex-col justify-between bg-black/40 rounded-lg">
                                                            <div
                                                                className="flex items-center justify-end gap-1 flex-wrap p-2">
                                                                <div
                                                                    className="text-white text-sm bg-gray-700 py-1 px-2 rounded-full">
                                            ...
                                            {teamMembers.map(member => (
                                                <div key={member.id} className="bg-white rounded-lg p-2.5 shadow-lg">
                                                    <div className="relative group">
                                                        <img className="rounded-lg w-full h-96 object-cover"
                                                             src={member.image} alt={member.name}/>
                                                        <div
                                                            className="absolute inset-0 h-full flex flex-col justify-between bg-black/40 rounded-lg group-hover:opacity-0 transition-all duration-300">
                                                            <div></div>
                                                            <div className="p-2">
                                                    ...
                                                    <div className="pt-3 ml-1 flex items-center justify-between">
                                                        ...
                                                        <div className="inline-flex mt-3 gap-2">
                                                            {['facebook', 'instagram', 'youtube', 'twitter'].map(platform => (
                                                                <a key={platform} href="#"
                                                                   className="w-6 h-6 bg-gray-300 rounded"></a>
                                                            ))}
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            {activeTab === 'hakkimda' && (
                                <div className="space-y-3">
                                    <h1 className="text-gray-900 text-2xl font-semibold">Sanal Sahneleme Yapay Zeka
                                        Hakkında</h1>
                                    ...
                                    <p className="text-gray-500">Lorem ipsum dolor sit amet consectetur, adipisicing
                                        elit. Eligendi iure voluptas numquam exercitationem aliquam illum totam vero
                                        quasi quo repellat, suscipit nam commodi! Ratione incidunt amet tenetur magni
                                        temporibus asperiores? Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                        Repellat dignissimos facere exercitationem possimus sunt praesentium, dolorum
                                        ipsam iste blanditiis repellendus?</p>
                                    <h2 className="text-xl font-semibold text-gray-900">Örnek Başlık</h2>
                                    <p className="text-gray-500">Lorem ipsum dolor sit amet consectetur, adipisicing
                                        elit. Eligendi iure voluptas numquam exercitationem aliquam illum totam vero
                                        quasi quo repellat, suscipit nam commodi! Ratione incidunt amet tenetur magni
                                        temporibus asperiores?</p>
                                    <h2 className="text-xl font-semibold text-gray-900">Örnek Başlık</h2>
                                    <p className="text-gray-500">Lorem ipsum dolor sit amet consectetur, adipisicing
                                        elit. Eligendi iure voluptas numquam exercitationem aliquam illum totam vero
                                        quasi quo repellat, suscipit nam commodi! Ratione incidunt amet tenetur magni
                            ...
                            {activeTab === 'odullerim' && (
                                <div className="space-y-3">
                                    ...
                                    <div className="grid lg:grid-cols-6 md:grid-cols-4 grid-cols-2 gap-2">
                                        {awards.map(award => (
                                            <div key={award.id}
                                                 className="border border-black rounded-lg p-2 text-black text-center">
                                                <h6 className="text-sm">
                                                    <Medal className="inline w-5 h-5 mr-1"/>
                                                    {award.year}
                                                </h6>
                            ...
                            {activeTab === 'yorumlar' && (
                                    ...
                                    <div className="space-y-4">
                                        <div className="space-y-4 pb-5 border-b">
                                            <div className="flex items-center justify-between">
                                                ...
                                                <button
                                                    className="py-2 px-5 text-sm bg-orange-500 rounded-lg text-white">Değerlendir
                                                </button>
                                            </div>
                                            ...
                                            <div key={review.id} className="space-y-4 pb-5 border-b">
                                                <div
                                                    ...
                                                    <div className="inline-flex items-center md:gap-5 gap-2">
                                                        <h5 className="md:text-lg text-sm font-medium">Tavsiye etme
                                                            olasılığı çok yüksek</h5>
                              ...
                              {review.rating}
                                                    ...
                                                    <a href="#" className="md:text-sm text-xs text-orange-500">Bir sorun
                                                        bildir</a>
                                                </div>
                                                ...
                                                <div className="flex md:items-center items-start gap-3">
                                                    <img className="w-12 h-12 rounded-full object-cover"
                                                         src="public/ilan-gorsel.png" alt="Profile"/>
                                                    <div className="md:text-base text-sm">
                                                        <h5 className="font-semibold">{review.response.author}'dan {review.response.date} tarihli
                                                            yanıt</h5>
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="flex items-center gap-2 flex-wrap">
                                        {expertiseAreas.map((area, index) => (
                                            <div key={index}
                                                 className="bg-blue-600 rounded-full text-white text-sm py-2 px-4">
                                                {area}
                                            </div>
                                        ))}
                                    </div>
                                    ...
                                    <div className="bg-white p-6 rounded-lg border space-y-4">
                                        <div className="grid md:grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <input type="text"
                                                       className="border rounded-lg py-2 px-3 w-full focus:outline-none focus:ring-2 focus:ring-orange-500"/>
                                            </div>
                                            <div>
                                        ...
                                        <div>
                                            ...
                                            <textarea
                                                className="border rounded-lg py-2 px-3 w-full focus:outline-none focus:ring-2 focus:ring-orange-500"
                                                rows="5" placeholder="Mesajınızı buraya yazın..."></textarea>
                                        </div>
                                        <div className="flex items-center gap-2">
                                            <input type="checkbox" id="terms"/>
                                            <label htmlFor="terms" className="text-sm">Bu formu göndererek Kullanım
                                                Şartlarını kabul ediyorum.</label>
                                        </div>
                                        <button
                                            className="py-3 px-6 bg-orange-500 rounded-lg text-white font-medium hover:bg-orange-600 transition-colors">
                                            Mesaj Gönder
                                        </button>
                                    </div>
                                </div>
