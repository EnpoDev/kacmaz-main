...
const Danismananasayfaadvisorhome = () => {
    return (
        <>
                ...
                <div
                    ...
                    <div className="rounded-lg bg-white/70 p-8 text-black">
                        ...
                        <div className="flex flex-wrap items-center md:gap-4 gap-2 mt-3">
                            <button className="py-2 px-5 rounded-lg text-white bg-turuncu w-full md:w-auto">Konum
                            </button>
                            <button
                                className="py-2 px-5 rounded-lg bg-white focus:bg-turuncu focus:text-white w-full md:w-auto">İsim
                            </button>
                            <div
                                className="flex items-center justify-between py-2 px-3 bg-white rounded-lg md:w-[500px]">
                                <div className="flex items-center gap-2">
                                    <i className="ri-search-line ri-lg text-gray-400"></i>
                                    <input type="text" className="focus:outline-none bg-inherit"
                                           placeholder="Şehir, Mahalle veya Posta Kodu"/>
                                </div>
            ...
            <section className="container mx-auto py-16 px-32">
                <div className="text-center md:px-20 md:space-y-8 space-y-4">
                    <h2 className="md:text-4xl text-xl font-semibold text-turuncu">Bursa, Nilüfer’deki Emlak
                        Ofisleri</h2>
                    <p className="md:text-4xl text-lg font-medium">
                        Önde gelen aracı kurumların bir milyondan fazla ofisiyle, yerel ofis pazarınızı tanır ve sizi
                        sürecin başından sonuna kadar yönlendirebilir.
                    </p>
                </div>
                <div>
                    <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-4 mt-8">
                        <div
                            className="flex flex-col md:flex-row items-start gap-3 bg-white border rounded-lg p-3 shadow-lg">
                            <img className="md:w-[150px] w-full h-[170px] rounded-lg" src="./view/img/danisman.png"
                                 alt=""/>
            ...
            <section className="bg-[url('../img/banner.jpeg')] bg-cover bg-no-repeat lg:h-[400px] h-[300px] relative">
                ...
                <div
                    ...
                    <p className="lg:w-[630px] text-center font-semibold lg:text-2xl text-2xl">
                        Sizi, pazarınızla ilgili içeriden bilgi sahibi olan bir temsilcimizle eşleştireceğiz.
                    </p>
                    <button className="py-2 px-5 rounded-lg text-white bg-turuncu w-full md:w-auto">Yerel bir
                        temsilciyle bağlantı kurun
                    </button>
                </div>
            </section>
                ...
                <div className="mx-auto max-w-5xl text-white p-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="border-b border-white">
                            ...
                            <div className="faq-answer hidden text-white p-3">Çevrimiçi platformlarda müşteri
                                yorumlarına bakarak iyi bir emlakçı seçebilirsiniz.
                            </div>
                        </div>
                        ...
                        <div className="border-b border-white">
                            ...
                            <div className="faq-answer hidden text-white p-3">Komisyon ücretleri genellikle satış
                                fiyatının belirli bir yüzdesi olarak hesaplanır.
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="text-center py-16 space-y-2 px-5">
                ...
                <p className="md:w-[800px] mx-auto text-lg font-medşum">
                    Kaç m²m²Kaynak Merkezimizde, iş planı şablonlarından emlak pazarlamasına yönelik kapsamlı
                    kılavuzlara kadar her türlü kaynağa göz
                    atabilirsiniz. Henüz Pro Temsilci değil misiniz? KacM2’deki emlak reklamlarının daha fazla
                    potansiyel müşteri kazanmanıza nasıl yardımcı
...
export default Danismananasayfaadvisorhome;
