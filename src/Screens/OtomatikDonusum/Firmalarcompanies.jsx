  ...
  return (
    <>
      <button id="scrollToTop" className="fixed bottom-10 right-10 py-2 px-3 rounded-lg bg-turuncu text-white rounded-lgshadow-lg transition hidden z-[999999]">
          ...
          <section className="container mx-auto py-10 pl-5 md:pl-0 overflow-x-hidden">
            <div className="space-y-8">
              <div className="">
                <h2 className="text-2xl font-semibold">Popüler Hizmetler</h2>
                <div className="swiper mySwiper ">
                  <div className="swiper-wrapper py-4">
                    <div className="swiper-slide ">
                      <div className="hover:-translate-y-1 transition-all duration-500">
                        <img className="h-[170px] w-full rounded-t-lg" src="./view/img/services.jpg" alt="" />
                        <div
                          className="bg-white shadow-lg p-4 rounded-b-lg border text-center hover:underline underline-offset-8 decoration-black transition-all delay-200"
                        >
                          <a href="">Ev Tadilat</a>
                        </div>
                      </div>
                  ...
                  <div className="swiper-button-next bg-white p-4 text-center rounded-full font-medium hidden md:block custom-swiper-buttons"></div>
                  <div className="swiper-button-prev bg-white p-4 text-center rounded-full font-medium hidden md:block custom-swiper-buttons"></div>
                </div>
              </div>
              <div className="">
                <h2 className="text-2xl font-semibold">Ev Tasarımı ve Yenileme</h2>
                <div className="swiper mySwiper ">
                  <div className="swiper-wrapper py-4">
                    <div className="swiper-slide ">
                      <div className="hover:-translate-y-1 transition-all duration-500">
              ...
              <div className="">
                <h2 className="text-2xl font-semibold">Mimarlık & Mühendislik</h2>
                <div className="swiper mySwiper ">
                  <div className="swiper-wrapper py-4">
                    <div className="swiper-slide ">
                      <div className="hover:-translate-y-1 transition-all duration-500">
              ...
              <div className="">
                <h2 className="text-2xl font-semibold">Bayi ve Satıcılar</h2>
                <div className="swiper mySwiper ">
                  <div className="swiper-wrapper py-4">
                    <div className="swiper-slide ">
                      <div className="hover:-translate-y-1 transition-all duration-500">
              ...
              <div className="">
                <h2 className="text-2xl font-semibold">Bahçe ve Peyzaj</h2>
                <div className="swiper mySwiper ">
                  <div className="swiper-wrapper py-4">
                    <div className="swiper-slide ">
                      <div className="hover:-translate-y-1 transition-all duration-500">
              ...
              <div className="">
                <h2 className="text-2xl font-semibold">Boya ve Badana</h2>
                <div className="swiper mySwiper ">
                  <div className="swiper-wrapper py-4">
                    <div className="swiper-slide ">
                      <div className="hover:-translate-y-1 transition-all duration-500">
              ...
              <div className="">
                <h2 className="text-2xl font-semibold">Çatı ve Oluk</h2>
                <div className="swiper mySwiper ">
                  <div className="swiper-wrapper py-4">
                    <div className="swiper-slide ">
                      <div className="hover:-translate-y-1 transition-all duration-500">
              ...
              <div className="">
                <h2 className="text-2xl font-semibold">Çilingir</h2>
                <div className="swiper mySwiper ">
                  <div className="swiper-wrapper py-4">
                    <div className="swiper-slide ">
                      <div className="hover:-translate-y-1 transition-all duration-500">
              ...
              <div className="">
                <h2 className="text-2xl font-semibold">Duvar, Tavan ve Alçı</h2>
                <div className="swiper mySwiper ">
                  <div className="swiper-wrapper py-4">
                    <div className="swiper-slide ">
                      <div className="hover:-translate-y-1 transition-all duration-500">
              ...
              <div className="">
                <h2 className="text-2xl font-semibold">Elektrik & Elektronik ve Aydınlatma</h2>
                <div className="swiper mySwiper ">
                  <div className="swiper-wrapper py-4">
                    <div className="swiper-slide ">
                      <div className="hover:-translate-y-1 transition-all duration-500">
              ...
              <div className="">
                <h2 className="text-2xl font-semibold">Alarm & Güvenlik</h2>
                <div className="swiper mySwiper ">
                  <div className="swiper-wrapper py-4">
                    <div className="swiper-slide ">
                      <div className="hover:-translate-y-1 transition-all duration-500">
              ...
              <div className="">
                <h2 className="text-2xl font-semibold">Isıtma, Soğutma ve Havalandırma</h2>
                <div className="swiper mySwiper ">
                  <div className="swiper-wrapper py-4">
                    <div className="swiper-slide ">
                      <div className="hover:-translate-y-1 transition-all duration-500">
              ...
              <div className="">
                <h2 className="text-2xl font-semibold">İnşaat & Harfiyat</h2>
                <div className="swiper mySwiper ">
                  <div className="swiper-wrapper py-4">
                    <div className="swiper-slide ">
                      <div className="hover:-translate-y-1 transition-all duration-500">
              ...
              <div className="">
                <h2 className="text-2xl font-semibold">Kapı, Pencere, Cam & Cam Balkon</h2>
                <div className="swiper mySwiper ">
                  <div className="swiper-wrapper py-4">
                    <div className="swiper-slide ">
                      <div className="hover:-translate-y-1 transition-all duration-500">
              ...
              <div className="">
                <h2 className="text-2xl font-semibold">Mobilya ve Marangoz</h2>
                <div className="swiper mySwiper ">
                  <div className="swiper-wrapper py-4">
                    <div className="swiper-slide ">
                      <div className="hover:-translate-y-1 transition-all duration-500">
              ...
              <div className="">
                <h2 className="text-2xl font-semibold">Mutfak ve Banyo Tadilat</h2>
                <div className="swiper mySwiper ">
                  <div className="swiper-wrapper py-4">
                    <div className="swiper-slide ">
                      <div className="hover:-translate-y-1 transition-all duration-500">
              ...
              <div className="">
                <h2 className="text-2xl font-semibold">Su Tesisatı</h2>
                <div className="swiper mySwiper ">
                  <div className="swiper-wrapper py-4">
                    <div className="swiper-slide ">
                      <div className="hover:-translate-y-1 transition-all duration-500">
              ...
              <div className="">
                <h2 className="text-2xl font-semibold">Yalıtım ve Mantolama</h2>
                <div className="swiper mySwiper ">
                  <div className="swiper-wrapper py-4">
                    <div className="swiper-slide ">
                      <div className="hover:-translate-y-1 transition-all duration-500">
              ...
              <div className="">
                <h2 className="text-2xl font-semibold">Yer Döşeme ve Kaplama</h2>
                <div className="swiper mySwiper ">
                  <div className="swiper-wrapper py-4">
                    <div className="swiper-slide ">
                      <div className="hover:-translate-y-1 transition-all duration-500">
              ...
              <div className="">
                <h2 className="text-2xl font-semibold">Demir & Ferforje</h2>
                <div className="swiper mySwiper ">
                  <div className="swiper-wrapper py-4">
                    <div className="swiper-slide ">
                      <div className="hover:-translate-y-1 transition-all duration-500">
              ...
              <div className="">
                <h2 className="text-2xl font-semibold">Mobilya ve Döşeme</h2>
                <div className="swiper mySwiper ">
                  <div className="swiper-wrapper py-4">
                    <div className="swiper-slide ">
                      <div className="hover:-translate-y-1 transition-all duration-500">
              ...
              <div className="">
                <h2 className="text-2xl font-semibold">Temizlik & İlaçlama</h2>
                <div className="swiper mySwiper ">
                  <div className="swiper-wrapper py-4">
                    <div className="swiper-slide ">
                      <div className="hover:-translate-y-1 transition-all duration-500">
          ...
          <section className="container mx-auto px-5 lg:px-0">
            ...
            <div className="space-y-2 py-5">
              <div className="flex flex-col md:flex-row items-start gap-5 pb-4 border-b">
                <div className="swiper mySwiper2 md:w-1/4">
                  <div className="swiper-wrapper">
                    <div className="swiper-slide"><img className="h-[210px] md:w-full rounded-lg" src="./view/img/services-slider.jpg" alt="" /></div>
                    <div className="swiper-slide"><img className="h-[210px] md:w-full rounded-lg" src="./view/img/services-slider.jpg" alt="" /></div>
                  </div>
                ...
                <div className="md:w-1/2 space-y-2">
                  <div className="inline-flex items-center gap-2">
                    <img className="md:w-[60px] w-[40px] md:h-[60px] h-[40px] rounded-full" src="./view/img/pp.png" alt="" />
                    <div>
                  ...
                  <div className="flex items-center flex-wrap gap-3">
                      <div className="py-1 px-2 rounded-lg bg-gray-200 text-sm">
                          <i className="ri-medal-line"></i> En Çok Satış
                      </div>
                      <div className="py-1 px-2 rounded-lg bg-gray-200 text-sm">
                          <i className="ri-medal-line"></i> En Çok Satış
                      </div>
                  ...
                  <div className="text-gray-500">
                      ...
                      <a href="" className="flex items-center justify-end text-black">Devamını Oku <i className="ri-arrow-right-s-line"></i></a>
                  </div>
                </div>
                <div className="md:w-1/4">
                  <button className="py-2 px-4 border rounded-lg border-mavi text-mavi font-medium w-full">
                      <i className="ri-mail-line"></i> Mesaj Gönderin
                  </button>
...
export default Firmalarcompanies;
